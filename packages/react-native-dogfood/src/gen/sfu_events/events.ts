...
// @generated from protobuf file "sfu_events/events.proto" (package "stream.video.sfu", syntax proto3)
// tslint:disable
...
import { Codec } from "../sfu_models/models";
import { ConnectionQuality } from "../sfu_models/models";
import { StreamQuality } from "../sfu_models/models";
import { Participant } from "../sfu_models/models";
import { Call } from "../sfu_models/models";
/**
 * @generated from protobuf message stream.video.sfu.SfuEvent
 */
export interface SfuEvent {
    ...
    eventPayload: {
        ...
        /**
         * @generated from protobuf field: stream.video.sfu.SubscriberOffer subscriber_offer = 1;
         */
        subscriberOffer: SubscriberOffer;
    } | {
        oneofKind: "connectionQualityChanged";
        /**
         * @generated from protobuf field: stream.video.sfu.ConnectionQualityChanged connection_quality_changed = 2;
         */
        connectionQualityChanged: ConnectionQualityChanged;
    } | {
        oneofKind: "audioLevelChanged";
        /**
         * @generated from protobuf field: stream.video.sfu.AudioLevelChanged audio_level_changed = 3;
         */
        audioLevelChanged: AudioLevelChanged;
    } | {
        oneofKind: "subscriberCandidate";
        /**
         * @generated from protobuf field: stream.video.sfu.ICECandidateTrickle subscriber_candidate = 4;
         */
        subscriberCandidate: ICECandidateTrickle;
    } | {
        oneofKind: "publisherCandidate";
        /**
         * @generated from protobuf field: stream.video.sfu.ICECandidateTrickle publisher_candidate = 5;
         */
        publisherCandidate: ICECandidateTrickle;
    } | {
        oneofKind: "changePublishQuality";
        /**
         * @generated from protobuf field: stream.video.sfu.ChangePublishQuality change_publish_quality = 6;
         */
        changePublishQuality: ChangePublishQuality;
    } | {
        oneofKind: "localDeviceChange";
        /**
         * @generated from protobuf field: stream.video.sfu.LocalDeviceChange local_device_change = 7;
         */
        localDeviceChange: LocalDeviceChange;
    } | {
        oneofKind: "muteStateChanged";
        /**
         * @generated from protobuf field: stream.video.sfu.MuteStateChanged mute_state_changed = 8;
         */
        muteStateChanged: MuteStateChanged;
    } | {
        oneofKind: "videoQualityChanged";
        /**
         * @generated from protobuf field: stream.video.sfu.VideoQualityChanged video_quality_changed = 9;
         */
        videoQualityChanged: VideoQualityChanged;
    } | {
        oneofKind: "participantJoined";
        /**
         * @generated from protobuf field: stream.video.sfu.ParticipantJoined participant_joined = 10;
         */
        participantJoined: ParticipantJoined;
    } | {
        oneofKind: "participantLeft";
        /**
         * @generated from protobuf field: stream.video.sfu.ParticipantLeft participant_left = 11;
         */
        participantLeft: ParticipantLeft;
    } | {
        oneofKind: "dominantSpeakerChanged";
        /**
         * @generated from protobuf field: stream.video.sfu.DominantSpeakerChanged dominant_speaker_changed = 12;
         */
 ...
 *
 * @generated from protobuf message stream.video.sfu.ParticipantJoined
 */
export interface ParticipantJoined {
    /**
     * @generated from protobuf field: stream.video.sfu.Call call = 1;
     */
    call?: Call;
    /**
     * @generated from protobuf field: stream.video.sfu.Participant participant = 2;
     */
 ...
 *
 * @generated from protobuf message stream.video.sfu.ParticipantLeft
 */
...
/**
 * @generated from protobuf message stream.video.sfu.MuteStateChanged
 */
 ...
 *
 * @generated from protobuf message stream.video.sfu.VideoQualityChanged
 */
 ...
 *
 * @generated from protobuf message stream.video.sfu.SubscriberOffer
 */
...
/**
 * @generated from protobuf message stream.video.sfu.LocalDeviceChange
 */
 ...
 *
 * @generated from protobuf message stream.video.sfu.ICECandidateTrickle
 */
 ...
 *
 * @generated from protobuf message stream.video.sfu.ConnectionQualityChanged
 */
export interface ConnectionQualityChanged {
    ...
    userId: string;
    /**
     * @generated from protobuf field: stream.video.sfu.ConnectionQuality connection_quality = 2;
     */
 ...
 *
 * @generated from protobuf message stream.video.sfu.DominantSpeakerChanged
 */
 ...
 *
 * @generated from protobuf message stream.video.sfu.AudioLevelChanged
 */
export interface AudioLevelChanged {
    /**
     * @generated from protobuf field: repeated stream.video.sfu.AudioLevel audio_levels = 1;
     */
    audioLevels: AudioLevel[];
}
/**
 * @generated from protobuf message stream.video.sfu.AudioLevel
 */
...
/**
 * @generated from protobuf message stream.video.sfu.AudioLayerSetting
 */
export interface AudioLayerSetting {
}
/**
 * @generated from protobuf message stream.video.sfu.AudioMediaRequest
 */
...
/**
 * @generated from protobuf message stream.video.sfu.AudioSender
 */
export interface AudioSender {
    /**
     * @generated from protobuf field: stream.video.sfu.AudioMediaRequest mediaRequest = 1;
     */
    mediaRequest?: AudioMediaRequest;
    /**
     * @generated from protobuf field: stream.video.sfu.Codec codec = 2;
     */
    codec?: Codec;
    /**
     * @generated from protobuf field: repeated stream.video.sfu.AudioLayerSetting layers = 3;
     */
    layers: AudioLayerSetting[];
}
/**
 * @generated from protobuf message stream.video.sfu.VideoMediaRequest
 */
...
/**
 * @generated from protobuf message stream.video.sfu.VideoLayerSetting
 */
export interface VideoLayerSetting {
    ...
    /**
     * @generated from protobuf field: stream.video.sfu.VideoLayerSetting.Priority priority = 5;
     */
    priority: VideoLayerSetting_Priority;
    /**
     * @generated from protobuf field: stream.video.sfu.Codec codec = 6;
     */
    codec?: Codec;
}
/**
 * @generated from protobuf enum stream.video.sfu.VideoLayerSetting.Priority
 */
...
/**
 * @generated from protobuf message stream.video.sfu.VideoSender
 */
export interface VideoSender {
    /**
     * @generated from protobuf field: stream.video.sfu.VideoMediaRequest mediaRequest = 1;
     */
    ...
    codec?: Codec;
    /**
     * @generated from protobuf field: repeated stream.video.sfu.VideoLayerSetting layers = 3;
     */
 ...
 *
 * @generated from protobuf message stream.video.sfu.ChangePublishQuality
 */
export interface ChangePublishQuality {
    /**
     * @generated from protobuf field: repeated stream.video.sfu.AudioSender audio_sender = 1;
     */
    audioSender: AudioSender[];
    /**
     * @generated from protobuf field: repeated stream.video.sfu.VideoSender video_sender = 2;
     */
...
class SfuEvent$Type extends MessageType<SfuEvent> {
    constructor() {
        super("stream.video.sfu.SfuEvent", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SfuEvent): SfuEvent {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* stream.video.sfu.SubscriberOffer subscriber_offer */ 1:
                    ...
                    break;
                case /* stream.video.sfu.ConnectionQualityChanged connection_quality_changed */ 2:
                    message.eventPayload = {
                        oneofKind: "connectionQualityChanged",
                    ...
                    break;
                case /* stream.video.sfu.AudioLevelChanged audio_level_changed */ 3:
                    message.eventPayload = {
                        oneofKind: "audioLevelChanged",
                    ...
                    break;
                case /* stream.video.sfu.ICECandidateTrickle subscriber_candidate */ 4:
                    message.eventPayload = {
                        oneofKind: "subscriberCandidate",
                    ...
                    break;
                case /* stream.video.sfu.ICECandidateTrickle publisher_candidate */ 5:
                    message.eventPayload = {
                        oneofKind: "publisherCandidate",
                    ...
                    break;
                case /* stream.video.sfu.ChangePublishQuality change_publish_quality */ 6:
                    message.eventPayload = {
                        oneofKind: "changePublishQuality",
                    ...
                    break;
                case /* stream.video.sfu.LocalDeviceChange local_device_change */ 7:
                    message.eventPayload = {
                        oneofKind: "localDeviceChange",
                    ...
                    break;
                case /* stream.video.sfu.MuteStateChanged mute_state_changed */ 8:
                    message.eventPayload = {
                        oneofKind: "muteStateChanged",
                    ...
                    break;
                case /* stream.video.sfu.VideoQualityChanged video_quality_changed */ 9:
                    message.eventPayload = {
                        oneofKind: "videoQualityChanged",
                    ...
                    break;
                case /* stream.video.sfu.ParticipantJoined participant_joined */ 10:
                    message.eventPayload = {
                        oneofKind: "participantJoined",
                    ...
                    break;
                case /* stream.video.sfu.ParticipantLeft participant_left */ 11:
                    message.eventPayload = {
                        oneofKind: "participantLeft",
                    ...
                    break;
                case /* stream.video.sfu.DominantSpeakerChanged dominant_speaker_changed */ 12:
                    message.eventPayload = {
                        oneofKind: "dominantSpeakerChanged",
    ...
    internalBinaryWrite(message: SfuEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.video.sfu.SubscriberOffer subscriber_offer = 1; */
        ...
        /* stream.video.sfu.ConnectionQualityChanged connection_quality_changed = 2; */
        ...
        /* stream.video.sfu.AudioLevelChanged audio_level_changed = 3; */
        ...
        /* stream.video.sfu.ICECandidateTrickle subscriber_candidate = 4; */
        ...
        /* stream.video.sfu.ICECandidateTrickle publisher_candidate = 5; */
        ...
        /* stream.video.sfu.ChangePublishQuality change_publish_quality = 6; */
        ...
        /* stream.video.sfu.LocalDeviceChange local_device_change = 7; */
        ...
        /* stream.video.sfu.MuteStateChanged mute_state_changed = 8; */
        ...
        /* stream.video.sfu.VideoQualityChanged video_quality_changed = 9; */
        ...
        /* stream.video.sfu.ParticipantJoined participant_joined = 10; */
        ...
        /* stream.video.sfu.ParticipantLeft participant_left = 11; */
        ...
        /* stream.video.sfu.DominantSpeakerChanged dominant_speaker_changed = 12; */
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.SfuEvent
 */
export const SfuEvent = new SfuEvent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ParticipantJoined$Type extends MessageType<ParticipantJoined> {
    constructor() {
        super("stream.video.sfu.ParticipantJoined", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ParticipantJoined): ParticipantJoined {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.video.sfu.Call call */ 1:
                    message.call = Call.internalBinaryRead(reader, reader.uint32(), options, message.call);
                    break;
                case /* stream.video.sfu.Participant participant */ 2:
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.MuteStateChanged
 */
...
class VideoQualityChanged$Type extends MessageType<VideoQualityChanged> {
    constructor() {
        super("stream.video.sfu.VideoQualityChanged", [
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.VideoQualityChanged
 */
...
class SubscriberOffer$Type extends MessageType<SubscriberOffer> {
    constructor() {
        super("stream.video.sfu.SubscriberOffer", [
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.LocalDeviceChange
 */
...
class ICECandidateTrickle$Type extends MessageType<ICECandidateTrickle> {
    constructor() {
        super("stream.video.sfu.ICECandidateTrickle", [
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.ICECandidateTrickle
 */
...
class ConnectionQualityChanged$Type extends MessageType<ConnectionQualityChanged> {
    constructor() {
        super("stream.video.sfu.ConnectionQualityChanged", [
            { no: 1, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "connection_quality", kind: "enum", T: () => ["stream.video.sfu.ConnectionQuality", ConnectionQuality] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string user_id */ 1:
                    message.userId = reader.string();
                    break;
                case /* stream.video.sfu.ConnectionQuality connection_quality */ 2:
    ...
    internalBinaryWrite(message: ConnectionQualityChanged, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.userId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.userId);
        /* stream.video.sfu.ConnectionQuality connection_quality = 2; */
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.ConnectionQualityChanged
 */
...
class DominantSpeakerChanged$Type extends MessageType<DominantSpeakerChanged> {
    constructor() {
        super("stream.video.sfu.DominantSpeakerChanged", [
            { no: 1, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.DominantSpeakerChanged
 */
...
class AudioLevelChanged$Type extends MessageType<AudioLevelChanged> {
    constructor() {
        super("stream.video.sfu.AudioLevelChanged", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AudioLevelChanged): AudioLevelChanged {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.sfu.AudioLevel audio_levels */ 1:
    ...
    internalBinaryWrite(message: AudioLevelChanged, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.sfu.AudioLevel audio_levels = 1; */
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.AudioLevelChanged
 */
export const AudioLevelChanged = new AudioLevelChanged$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AudioLevel$Type extends MessageType<AudioLevel> {
    constructor() {
        super("stream.video.sfu.AudioLevel", [
            { no: 1, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.AudioLevel
 */
export const AudioLevel = new AudioLevel$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AudioLayerSetting$Type extends MessageType<AudioLayerSetting> {
    constructor() {
        super("stream.video.sfu.AudioLayerSetting", []);
    }
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.AudioLayerSetting
 */
...
class AudioMediaRequest$Type extends MessageType<AudioMediaRequest> {
    constructor() {
        super("stream.video.sfu.AudioMediaRequest", [
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.AudioMediaRequest
 */
export const AudioMediaRequest = new AudioMediaRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AudioSender$Type extends MessageType<AudioSender> {
    constructor() {
        super("stream.video.sfu.AudioSender", [
    ...
    internalBinaryWrite(message: AudioSender, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.video.sfu.AudioMediaRequest mediaRequest = 1; */
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.AudioSender
 */
export const AudioSender = new AudioSender$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VideoMediaRequest$Type extends MessageType<VideoMediaRequest> {
    constructor() {
        super("stream.video.sfu.VideoMediaRequest", [
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.VideoMediaRequest
 */
...
class VideoLayerSetting$Type extends MessageType<VideoLayerSetting> {
    constructor() {
        super("stream.video.sfu.VideoLayerSetting", [
            ...
            { no: 5, name: "priority", kind: "enum", T: () => ["stream.video.sfu.VideoLayerSetting.Priority", VideoLayerSetting_Priority] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* float scaleResolutionDownBy */ 4:
                    ...
                    break;
                case /* stream.video.sfu.VideoLayerSetting.Priority priority */ 5:
                    message.priority = reader.int32();
                    break;
                case /* stream.video.sfu.Codec codec */ 6:
                    message.codec = Codec.internalBinaryRead(reader, reader.uint32(), options, message.codec);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: VideoLayerSetting, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.video.sfu.VideoLayerSetting.Priority priority = 5; */
        if (message.priority !== 0)
            writer.tag(5, WireType.Varint).int32(message.priority);
        /* stream.video.sfu.Codec codec = 6; */
        if (message.codec)
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.VideoLayerSetting
 */
export const VideoLayerSetting = new VideoLayerSetting$Type();
// @generated message type with reflection information, may provide speed optimized methods
class VideoSender$Type extends MessageType<VideoSender> {
    constructor() {
        super("stream.video.sfu.VideoSender", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: VideoSender): VideoSender {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.video.sfu.VideoMediaRequest mediaRequest */ 1:
                    message.mediaRequest = VideoMediaRequest.internalBinaryRead(reader, reader.uint32(), options, message.mediaRequest);
                    break;
                case /* stream.video.sfu.Codec codec */ 2:
                    message.codec = Codec.internalBinaryRead(reader, reader.uint32(), options, message.codec);
                    break;
                case /* repeated stream.video.sfu.VideoLayerSetting layers */ 3:
...
class ChangePublishQuality$Type extends MessageType<ChangePublishQuality> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChangePublishQuality): ChangePublishQuality {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.sfu.AudioSender audio_sender */ 1:
                    message.audioSender.push(AudioSender.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated stream.video.sfu.VideoSender video_sender */ 2:
    ...
    internalBinaryWrite(message: ChangePublishQuality, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.sfu.AudioSender audio_sender = 1; */
        ...
        /* repeated stream.video.sfu.VideoSender video_sender = 2; */
...
/**
 * @generated MessageType for protobuf message stream.video.sfu.ChangePublishQuality
 */
