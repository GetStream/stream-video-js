...
GoogleSignin.configure({
  ...
  // forceCodeForRefreshToken: true, // [AndroidTEMP] related to `serverAuthCode`, read the docs link below *.
  // accountName: '', // [AndroidTEMP] specifies an account name on the device that should be used
