...
type LobbyViewScreenProps = NativeStackScreenProps<
  GuestModeParamList,
  'GuestLobbyViewScreen'
>;

export const GuestLobbyViewScreen = ({ route }: LobbyViewScreenProps) => {
  ...
  if (client) {
    appStoreSetState({ client: client });
  }
  ...
  return (
    <View style={[StyleSheet.absoluteFill, styles.container]}>
      ...
      <Pressable
        ...
        onPress={() => {
          appStoreSetState({ appMode: 'Meeting' });
        }}
      >
        <Text style={styles.anonymousButtonText}>
          Continue with your logged in account
        </Text>
      </Pressable>
    </View>
  );
