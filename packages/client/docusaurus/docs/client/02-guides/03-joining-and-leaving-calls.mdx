...
This guide shows how to create, join, leave, and end call rooms and ring calls. To follow this guide, make sure that you have read the [call lifecycle guide](../02-call-lifecycle/) to understand the mental model behind the examples.
...
Ending a call requires a [special permission](../../advanced/03-permissions-and-capabilities). This action terminates the call for everyone.
