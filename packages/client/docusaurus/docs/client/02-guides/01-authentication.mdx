...
:::warning
Keep in mind to not expose your secret or your token to the public.
:::
...
For more information, please refer to our [Server-Side Integration guide](../../basics/08-server-side-integrations).
...
A typical use case for using an anonymous user are large webinars where you expect to have a lot of
