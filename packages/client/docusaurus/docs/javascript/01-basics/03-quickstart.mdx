...
This quickstart gives you a quick overview of how Stream's video JavaScript client works.
...
The JavaScript client provides reactive state management, which makes it easy to trigger UI updates. Let's see how we can render the video and audio of all participants:
