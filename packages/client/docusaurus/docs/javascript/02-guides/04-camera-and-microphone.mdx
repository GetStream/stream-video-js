...
This is React specific, the pure JS client uses helpers defined here: https://github.com/GetStream/stream-video-js/blob/main/packages/client/src/devices/devices.ts.
