...
export interface Member {
    /**
     * The RID of the room this member belongs to
     *
...
class Member$Type extends MessageType<Member> {
    constructor() {
        super("stream.video.coordinator.member_v1.Member", [
            { no: 1, name: "room_rid", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1" } } } },
    ...
    create(value?: PartialMessage<Member>): Member {
        const message = { roomRid: "", userId: "", role: "", customJson: new Uint8Array(0) };
