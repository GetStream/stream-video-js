...
export interface CreateCallRequest {
     ...
     *
     * @generated from protobuf field: stream.video.coordinator.feature_v1.TranscribeOptions transcribe_options = 9;
     */
...
export interface AddDeviceResponse {
    /**
     * @generated from protobuf field: stream.video.coordinator.device_v1.Device device = 1;
     */
    device?: Device;
}
/**
...
export interface ListDevicesResponse {
    /**
     * @generated from protobuf field: repeated stream.video.coordinator.device_v1.Device devices = 1;
     */
    devices: Device[];
}
/**
...
export interface JoinCallResponse {
    ...
    edges: Edge[];
    /**
     * @generated from protobuf field: repeated stream.video.coordinator.permission_v1.UserCapability own_capabilities = 5;
     */
...
export interface WebsocketAuthRequest {
     ...
     *
     * @generated from protobuf field: stream.video.coordinator.device_v1.DeviceInput device = 4;
     */
    device?: DeviceInput;
}
/**
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.BoolValue transcribe */ 8:
                    ...
                    break;
                case /* stream.video.coordinator.feature_v1.TranscribeOptions transcribe_options */ 9:
...
class AddDeviceResponse$Type extends MessageType<AddDeviceResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AddDeviceResponse): AddDeviceResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.video.coordinator.device_v1.Device device */ 1:
    ...
    internalBinaryWrite(message: AddDeviceResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.video.coordinator.device_v1.Device device = 1; */
        if (message.device)
...
class ListDevicesResponse$Type extends MessageType<ListDevicesResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListDevicesResponse): ListDevicesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.coordinator.device_v1.Device devices */ 1:
    ...
    internalBinaryWrite(message: ListDevicesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.coordinator.device_v1.Device devices = 1; */
...
class JoinCallResponse$Type extends MessageType<JoinCallResponse> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated stream.video.coordinator.edge_v1.Edge edges */ 4:
                    ...
                    break;
                case /* repeated stream.video.coordinator.permission_v1.UserCapability own_capabilities */ 5:
    ...
    internalBinaryWrite(message: JoinCallResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated stream.video.coordinator.permission_v1.UserCapability own_capabilities = 5; */
...
class WebsocketAuthRequest$Type extends MessageType<WebsocketAuthRequest> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* stream.video.coordinator.user_v1.UserInput user */ 3:
                    ...
                    break;
                case /* stream.video.coordinator.device_v1.DeviceInput device */ 4:
    ...
    internalBinaryWrite(message: WebsocketAuthRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.video.coordinator.device_v1.DeviceInput device = 4; */
        if (message.device)
