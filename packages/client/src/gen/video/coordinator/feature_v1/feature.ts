...
// @generated from protobuf file "video/coordinator/feature_v1/feature.proto" (package "stream.video.coordinator.feature_v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message stream.video.coordinator.feature_v1.TranscribeOptions
 */
export interface TranscribeOptions {
}
/**
 * @generated from protobuf message stream.video.coordinator.feature_v1.Features
 */
export interface Features {
    /**
     * Recording calls.
     *
     * @generated from protobuf field: stream.video.coordinator.feature_v1.FeatureToggle recording = 1;
     */
    recording: FeatureToggle;
    /**
     * HLS stream broadcast.
     *
     * @generated from protobuf field: stream.video.coordinator.feature_v1.FeatureToggle hls_broadcast = 2;
     */
    hlsBroadcast: FeatureToggle;
    /**
     * Call transcription.
     *
     * @generated from protobuf field: stream.video.coordinator.feature_v1.FeatureToggle transcribe = 3;
     */
    transcribe: FeatureToggle;
    /**
     * @generated from protobuf field: stream.video.coordinator.feature_v1.TranscribeOptions transcribe_options = 4;
     */
    transcribeOptions?: TranscribeOptions;
}
/**
 * @generated from protobuf enum stream.video.coordinator.feature_v1.FeatureToggle
 */
...
class TranscribeOptions$Type extends MessageType<TranscribeOptions> {
    constructor() {
        super("stream.video.coordinator.feature_v1.TranscribeOptions", []);
    }
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.feature_v1.TranscribeOptions
 */
export const TranscribeOptions = new TranscribeOptions$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Features$Type extends MessageType<Features> {
    constructor() {
        super("stream.video.coordinator.feature_v1.Features", [
            { no: 1, name: "recording", kind: "enum", T: () => ["stream.video.coordinator.feature_v1.FeatureToggle", FeatureToggle, "FEATURE_TOGGLE_"] },
            { no: 2, name: "hls_broadcast", kind: "enum", T: () => ["stream.video.coordinator.feature_v1.FeatureToggle", FeatureToggle, "FEATURE_TOGGLE_"] },
            { no: 3, name: "transcribe", kind: "enum", T: () => ["stream.video.coordinator.feature_v1.FeatureToggle", FeatureToggle, "FEATURE_TOGGLE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Features): Features {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* stream.video.coordinator.feature_v1.FeatureToggle recording */ 1:
                    message.recording = reader.int32();
                    break;
                case /* stream.video.coordinator.feature_v1.FeatureToggle hls_broadcast */ 2:
                    message.hlsBroadcast = reader.int32();
                    break;
                case /* stream.video.coordinator.feature_v1.FeatureToggle transcribe */ 3:
                    message.transcribe = reader.int32();
                    break;
                case /* stream.video.coordinator.feature_v1.TranscribeOptions transcribe_options */ 4:
    ...
    internalBinaryWrite(message: Features, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.video.coordinator.feature_v1.FeatureToggle recording = 1; */
        if (message.recording !== 0)
            writer.tag(1, WireType.Varint).int32(message.recording);
        /* stream.video.coordinator.feature_v1.FeatureToggle hls_broadcast = 2; */
        if (message.hlsBroadcast !== 0)
            writer.tag(2, WireType.Varint).int32(message.hlsBroadcast);
        /* stream.video.coordinator.feature_v1.FeatureToggle transcribe = 3; */
        if (message.transcribe !== 0)
            writer.tag(3, WireType.Varint).int32(message.transcribe);
        /* stream.video.coordinator.feature_v1.TranscribeOptions transcribe_options = 4; */
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.feature_v1.Features
 */
