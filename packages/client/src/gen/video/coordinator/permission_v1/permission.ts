...
// @generated from protobuf file "video/coordinator/permission_v1/permission.proto" (package "stream.video.coordinator.permission_v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message stream.video.coordinator.permission_v1.Permission
 */
export interface Permission {
     ...
     *
     * @generated from protobuf field: stream.video.coordinator.permission_v1.Action action = 4;
     */
    action: Action;
    /**
...
/**
 * @generated from protobuf message stream.video.coordinator.permission_v1.Permissions
 */
export interface Permissions {
    /**
     * @generated from protobuf field: repeated stream.video.coordinator.permission_v1.Permission permissions = 1;
     */
    permissions: Permission[];
}
/**
 * @generated from protobuf message stream.video.coordinator.permission_v1.Grant
 */
export interface Grant {
    ...
    role: string;
    /**
     * @generated from protobuf field: repeated stream.video.coordinator.permission_v1.Action actions = 4;
     */
    actions: Action[];
}
/**
 * @generated from protobuf message stream.video.coordinator.permission_v1.UserCapability
 */
...
/**
 * @generated from protobuf enum stream.video.coordinator.permission_v1.Action
 */
export enum Action {
    /**
...
class Permission$Type extends MessageType<Permission> {
    constructor() {
        super("stream.video.coordinator.permission_v1.Permission", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "description", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "action", kind: "enum", T: () => ["stream.video.coordinator.permission_v1.Action", Action, "ACTION_"] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 3:
                    ...
                    break;
                case /* stream.video.coordinator.permission_v1.Action action */ 4:
    ...
    internalBinaryWrite(message: Permission, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.video.coordinator.permission_v1.Action action = 4; */
        if (message.action !== 0)
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.permission_v1.Permission
 */
export const Permission = new Permission$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Permissions$Type extends MessageType<Permissions> {
    constructor() {
        super("stream.video.coordinator.permission_v1.Permissions", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Permissions): Permissions {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.coordinator.permission_v1.Permission permissions */ 1:
    ...
    internalBinaryWrite(message: Permissions, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.coordinator.permission_v1.Permission permissions = 1; */
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.permission_v1.Permissions
 */
export const Permissions = new Permissions$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Grant$Type extends MessageType<Grant> {
    constructor() {
        super("stream.video.coordinator.permission_v1.Grant", [
            { no: 1, name: "call_type", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "call_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "role", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "actions", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["stream.video.coordinator.permission_v1.Action", Action, "ACTION_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string role */ 3:
                    ...
                    break;
                case /* repeated stream.video.coordinator.permission_v1.Action actions */ 4:
    ...
    internalBinaryWrite(message: Grant, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated stream.video.coordinator.permission_v1.Action actions = 4; */
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.permission_v1.Grant
 */
export const Grant = new Grant$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UserCapability$Type extends MessageType<UserCapability> {
    constructor() {
        super("stream.video.coordinator.permission_v1.UserCapability", [
...
/**
 * @generated MessageType for protobuf message stream.video.coordinator.permission_v1.UserCapability
 */
