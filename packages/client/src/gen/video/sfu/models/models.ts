...
class CallState$Type extends MessageType<CallState> {
    constructor() {
        super("stream.video.sfu.models.CallState", [
            ...
            { no: 3, name: "participant_count", kind: "message", T: () => ParticipantCount }
        ]);
    }
...
class Participant$Type extends MessageType<Participant> {
    constructor() {
        super("stream.video.sfu.models.Participant", [
            ...
            { no: 13, name: "roles", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Participant>): Participant {
        const message = { userId: "", sessionId: "", publishedTracks: [], trackLookupPrefix: "", connectionQuality: 0, isSpeaking: false, isDominantSpeaker: false, audioLevel: 0, name: "", image: "", roles: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class TrackInfo$Type extends MessageType<TrackInfo> {
    ...
    create(value?: PartialMessage<TrackInfo>): TrackInfo {
        const message = { trackId: "", trackType: 0, layers: [], mid: "", dtx: false, stereo: false, red: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Sdk$Type extends MessageType<Sdk> {
    constructor() {
        super("stream.video.sfu.models.Sdk", [
            { no: 1, name: "type", kind: "enum", T: () => ["stream.video.sfu.models.SdkType", SdkType, "SDK_TYPE_"] },
    ...
    create(value?: PartialMessage<Sdk>): Sdk {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Sdk>(this, message, value);
        return message;
    }
...
class OS$Type extends MessageType<OS> {
    ...
    create(value?: PartialMessage<OS>): OS {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<OS>(this, message, value);
        return message;
    }
...
class CallGrants$Type extends MessageType<CallGrants> {
    constructor() {
        super("stream.video.sfu.models.CallGrants", [
            { no: 1, name: "can_publish_audio", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "can_publish_video", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "can_screenshare", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<CallGrants>): CallGrants {
        const message = { canPublishAudio: false, canPublishVideo: false, canScreenshare: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
