...
// @generated from protobuf file "stat_v1/stat.proto" (package "stream.video.stat_v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message stream.video.stat_v1.CallStatEvent
 */
export interface CallStatEvent {
    /**
     * @generated from protobuf field: stream.video.stat_v1.CallStatEventType type = 1;
     */
...
/**
 * @generated from protobuf message stream.video.stat_v1.ParticipantCallStatEvent
 */
export interface ParticipantCallStatEvent {
    ...
    /**
     * @generated from protobuf field: repeated stream.video.stat_v1.CallStatEvent call_timelines = 2;
     */
    callTimelines: CallStatEvent[];
}
/**
 * @generated from protobuf message stream.video.stat_v1.CallStats
 */
export interface CallStats {
    /**
     * @generated from protobuf field: repeated stream.video.stat_v1.CallStatEvent call_timelines = 1;
     */
    callTimelines: CallStatEvent[];
    /**
     * @generated from protobuf field: repeated stream.video.stat_v1.ParticipantCallStatEvent participant_timelines = 2;
     */
    participantTimelines: ParticipantCallStatEvent[];
}
/**
 * @generated from protobuf enum stream.video.stat_v1.CallStatEventType
 */
...
class CallStatEvent$Type extends MessageType<CallStatEvent> {
    constructor() {
        super("stream.video.stat_v1.CallStatEvent", [
            { no: 1, name: "type", kind: "enum", T: () => ["stream.video.stat_v1.CallStatEventType", CallStatEventType, "CALL_STAT_EVENT_TYPE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallStatEvent): CallStatEvent {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* stream.video.stat_v1.CallStatEventType type */ 1:
    ...
    internalBinaryWrite(message: CallStatEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.video.stat_v1.CallStatEventType type = 1; */
        if (message.type !== 0)
...
/**
 * @generated MessageType for protobuf message stream.video.stat_v1.CallStatEvent
 */
...
class ParticipantCallStatEvent$Type extends MessageType<ParticipantCallStatEvent> {
    constructor() {
        super("stream.video.stat_v1.ParticipantCallStatEvent", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string participant_id */ 1:
                    ...
                    break;
                case /* repeated stream.video.stat_v1.CallStatEvent call_timelines */ 2:
    ...
    internalBinaryWrite(message: ParticipantCallStatEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated stream.video.stat_v1.CallStatEvent call_timelines = 2; */
...
/**
 * @generated MessageType for protobuf message stream.video.stat_v1.ParticipantCallStatEvent
 */
...
class CallStats$Type extends MessageType<CallStats> {
    constructor() {
        super("stream.video.stat_v1.CallStats", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallStats): CallStats {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.stat_v1.CallStatEvent call_timelines */ 1:
                    message.callTimelines.push(CallStatEvent.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated stream.video.stat_v1.ParticipantCallStatEvent participant_timelines */ 2:
    ...
    internalBinaryWrite(message: CallStats, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.stat_v1.CallStatEvent call_timelines = 1; */
        for (let i = 0; i < message.callTimelines.length; i++)
            CallStatEvent.internalBinaryWrite(message.callTimelines[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* repeated stream.video.stat_v1.ParticipantCallStatEvent participant_timelines = 2; */
...
/**
 * @generated MessageType for protobuf message stream.video.stat_v1.CallStats
 */
