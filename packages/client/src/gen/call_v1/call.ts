...
// @generated from protobuf file "call_v1/call.proto" (package "stream.video.call_v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message stream.video.call_v1.CallType
 */
export interface CallType {
     ...
     *
     * @generated from protobuf field: map<string, stream.video.permission_v1.Permissions> permissions = 2;
     */
    permissions: {
     ...
     *
     * @generated from protobuf field: stream.video.feature_v1.Features features = 3;
     */
    features?: Features;
    /**
...
/**
 * @generated from protobuf message stream.video.call_v1.CallState
 */
export interface CallState {
    /**
     * @generated from protobuf field: repeated stream.video.participant_v1.Participant participants = 1;
     */
    participants: Participant[];
}
/**
 * @generated from protobuf message stream.video.call_v1.Call
 */
export interface Call {
     ...
     *
     * @generated from protobuf field: stream.video.broadcast_v1.Broadcast broadcast = 9;
     */
    broadcast?: Broadcast;
    /**
    ...
    transcribe: boolean;
    /**
     * @generated from protobuf field: stream.video.feature_v1.TranscribeOptions transcribe_options = 11;
     */
...
class CallType$Type extends MessageType<CallType> {
    constructor() {
        super("stream.video.call_v1.CallType", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string name */ 1:
                    ...
                    break;
                case /* map<string, stream.video.permission_v1.Permissions> permissions */ 2:
                    this.binaryReadMap2(message.permissions, reader, options);
                    break;
                case /* stream.video.feature_v1.Features features */ 3:
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field stream.video.call_v1.CallType.permissions");
            }
        }
    ...
    internalBinaryWrite(message: CallType, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* map<string, stream.video.permission_v1.Permissions> permissions = 2; */
        ...
        /* stream.video.feature_v1.Features features = 3; */
        if (message.features)
...
/**
 * @generated MessageType for protobuf message stream.video.call_v1.CallType
 */
export const CallType = new CallType$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CallState$Type extends MessageType<CallState> {
    constructor() {
        super("stream.video.call_v1.CallState", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallState): CallState {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.video.participant_v1.Participant participants */ 1:
    ...
    internalBinaryWrite(message: CallState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.video.participant_v1.Participant participants = 1; */
...
/**
 * @generated MessageType for protobuf message stream.video.call_v1.CallState
 */
export const CallState = new CallState$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Call$Type extends MessageType<Call> {
    constructor() {
        super("stream.video.call_v1.Call", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool recording */ 8:
                    ...
                    break;
                case /* stream.video.broadcast_v1.Broadcast broadcast */ 9:
                ...
                case /* bool transcribe */ 10:
                    ...
                    break;
                case /* stream.video.feature_v1.TranscribeOptions transcribe_options */ 11:
    ...
    internalBinaryWrite(message: Call, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.video.broadcast_v1.Broadcast broadcast = 9; */
        ...
        /* stream.video.feature_v1.TranscribeOptions transcribe_options = 11; */
...
/**
 * @generated MessageType for protobuf message stream.video.call_v1.Call
 */
