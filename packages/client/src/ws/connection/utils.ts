...
//   return (
//     (user as OwnUserResponse<StreamChatGenerics>)?.total_unread_count !==
//     undefined
//   );
// }
...
//   return data;
// }
// export function normalizeQuerySort<
//   T extends Record<string, AscDesc | undefined>,
// >(sort: T | T[]) {
