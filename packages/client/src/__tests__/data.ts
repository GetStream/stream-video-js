...
export const CallCreatedPayload: CallCreatedEvent = {
  type: 'call.created',
  created_at: dateToNs(new Date('2025-08-14T14:48:39.988853336Z')),
  ...
  call: {
    ...
    created_by: {
      ...
      role: 'user',
      teams: [],
      created_at: dateToNs(new Date('2024-01-10T14:46:46.567417Z')),
      updated_at: dateToNs(new Date('2025-08-14T14:48:32.808624Z')),
      // @ts-expect-error outdated types
      banned: false,
      online: false,
      last_active: dateToNs(new Date('2025-08-12T11:50:03.973174Z')),
      blocked_user_ids: [],
    },
    custom: {},
    created_at: dateToNs(new Date('2025-08-14T14:48:39.958024Z')),
    updated_at: dateToNs(new Date('2025-08-14T14:48:39.958024Z')),
    recording: false,
    transcribing: false,
    captioning: false,
    ended_at: null,
  ...
  members: [
    {
      user: {
        ...
        role: 'user',
        teams: [],
        created_at: dateToNs(new Date('2024-01-10T13:26:19.889536Z')),
        updated_at: dateToNs(new Date('2025-08-07T07:35:43.81976Z')),
        // @ts-expect-error outdated types
        banned: false,
        online: false,
        last_active: dateToNs(new Date('2025-08-07T04:30:50.670932Z')),
        blocked_user_ids: [],
      },
      user_id: 'marcelo',
      custom: {},
      created_at: dateToNs(new Date('2025-08-14T14:48:39.9691Z')),
      updated_at: dateToNs(new Date('2025-08-14T14:48:39.9691Z')),
    },
    {
      user: {
        id: 'oliver',
  ...
  received_at: dateToNs(new Date('2025-08-14T14:48:39.973Z')),
};

export const CallRingPayload: CallRingEvent = {
  type: 'call.ring',
  created_at: dateToNs(new Date('2025-08-14T14:48:40.006646269Z')),
  call_cid: 'default:h6c44o00NeFTH6IvsGGgM',
  ...
  video: false,
  received_at: dateToNs(new Date('2025-08-14T14:48:39.990Z')),
};
