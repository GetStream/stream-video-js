## 1.6.0-rc.1 (2024-08-23)


### 🩹 Fixes

- rely on joinresponse before attempting to publish a stream

- do not use ended_at from call state to check ringing validity

- handle session_participant_count_updated event
