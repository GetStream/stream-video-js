...
open class StreamAudioFilterProcessingModule: RTCDefaultAudioProcessingModule,
    AudioProcessingModule, @unchecked Sendable
{
    ...
    public init(
        ...
        capturePostProcessingDelegate: AudioFilterCapturePostProcessingModule =
