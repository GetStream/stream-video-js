package com.streamvideo.reactnative.videofilters.common
...
class VideoFrameProcessorWithBitmapFilter(private val bitmapVideoFilterFunc: () -> BitmapVideoFilter): VideoFrameProcessor {
    ...
    override fun process(frame: VideoFrame, surfaceTextureHelper: SurfaceTextureHelper): VideoFrame {
        ...
        val inputFrameBitmap = YuvFrame.bitmapFromVideoFrame(frame)!!
        ...
        // Step 2: Apply filter
        bitmapVideoFilterFunc.invoke().applyFilter(inputFrameBitmap)
