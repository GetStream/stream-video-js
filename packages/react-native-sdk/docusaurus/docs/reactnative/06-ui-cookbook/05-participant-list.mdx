...
const MyActiveCall = () => {
  ...
  // Create a state that will hold the call instance.
  // Don't worry we will use the call instance in the next step.
...
import {CallControlsView, StreamCallProvider, usePublishStreams, useStreamVideoClient, } from '@stream-io/video-react-native-sdk';
import InCallManager from 'react-native-incall-manager';
