...
```bash
yarn add @stream-io/video-react-native-sdk react-native-webrtc react-native-device-info react-native-incall-manager react-native-svg text-encoding-polyfill react-native-url-polyfill intl-pluralrules @react-native-community/netinfo @notifee/react-native
```
