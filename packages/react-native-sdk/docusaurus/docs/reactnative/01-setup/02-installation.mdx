...
Stream Video React Native SDK requires installing some of the peer dependencies to provide you a great calling experience. You can run the following command to install them:
