...
_Note: Make sure to wrap your entire application in `StreamVideo`.
...
This will allow us to share and change the call params across the app.
...
export const JoinMeetingScreen = (props: JoinMeetingScreenProps) => {
  ...
  return (
    <SafeAreaView>
      ...
      <TextInput
        value={callId}
        onChangeText={(text) => setCallParams(
          prevState=> ({
            ...prevState,
