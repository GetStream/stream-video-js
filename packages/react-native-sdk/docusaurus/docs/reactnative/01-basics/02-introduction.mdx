...
The **Client** section contains information about core components you'll use to access the low level APIs, such as the main `StreamVideo` client as well as the underlying `VideoClient` which handles user tracks and media devices.
