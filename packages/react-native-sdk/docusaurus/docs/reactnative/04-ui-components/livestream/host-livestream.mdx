...
- A complete livestream UI with ability to stream host's video.
- Duration of the livestream with live indicator.
- Whether the stream is live and number of participant's watching the stream.
- Buttons to start and end the livestream and media control buttons to control publish and un-publish stream.

<ImageShowcase
  items={[
    {
      image: HostLivestreamStart,
      caption: 'Host Livestream Start',
      alt: 'Host Livestream Start',
    },
    {
      image: HostLivestreamEnd,
      caption: 'Host Livestream End',
      alt: 'Host Livestream End',
    },
  ]}
/>
