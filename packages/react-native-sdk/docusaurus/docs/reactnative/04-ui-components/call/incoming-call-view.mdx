...
The mostly handles the accept call button to override the default `onPress` event.
...
The mostly handles the reject call button to override the default `onPress` event.
