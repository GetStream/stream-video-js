...
Additionally, you can use the [`ViewerLivestream`](../../ui-components/livestream/viewer-livestream) component from our SDK, which offers the stream viewing capabililities along side the flexibility to apply your own customizations on top of this default UI.
