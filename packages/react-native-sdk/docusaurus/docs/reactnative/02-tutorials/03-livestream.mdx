...
const LivestreamUI = () => {
  ...
  // Automatically route audio to devices as relevant for watching videos.
...
The `useIncallManager` hook is used to automatically route audio to devices as relevant for watching videos.
...
- ** [Custom events](../../core/reactions-and-custom-events/) ** You can use custom events on the call to share any additional data. Think about showing the score for a game, or any other realtime use case.
