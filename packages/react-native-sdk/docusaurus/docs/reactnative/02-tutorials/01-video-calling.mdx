...
:::note
Start using your camera and microphone by learning how to manage your Native Permissions. See the [Manage Native Permissions](../../core/native-permissions) guide.
:::

For this tutorial, we can create the same hook as (`useSyncPermissions`) as in the [Manage Native Permissions](../../core/native-permissions) guide and use it as below:
...
![Video Call Video View](../assets/02-tutorials/01-video-calling/video-call-video-view.png)
...
![Video Call ParticipantView Info View](../assets/02-tutorials/01-video-calling/video-call-participants-info-view.png)
...
![Video Call Finished View](../assets/02-tutorials/01-video-calling/video-call-finished-view.png)
