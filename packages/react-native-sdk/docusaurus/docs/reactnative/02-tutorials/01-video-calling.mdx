...
- `Privacy - Microphone Usage Description` - "`VideoCallExample` app requires microphone access to capture and transmit audio"
...
In this step, we are going to add the participant's view which displays the participants' video and audio stream and other related info. We also add a call controls view that allows the user to control their streaming settings of audio and video.
...
![Preview of the video view](../assets/02-tutorials/01-video-calling/video-call-video-view.png)
...
- Show the information about the participants in a list view with the name, and status of media streaming.
...
![Preview of the list of participants](../assets/02-tutorials/01-video-calling/video-call-participants-info-view.png)
...
- `CallContentView` is the component that renders audio and video
- `CallControlsView`is the component that renders buttons to control streaming options
