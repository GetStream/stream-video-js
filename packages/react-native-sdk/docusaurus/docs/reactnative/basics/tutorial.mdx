...
The `StreamMeeting` component will take care of creating and joining a call.
...
### Render the video call

Our `ActiveCall` component consists of controls (hangup, un/mute audio/camera, invert camera)
and the video's of the participants.
