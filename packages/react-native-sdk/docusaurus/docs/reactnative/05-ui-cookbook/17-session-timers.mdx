...
const ExtendSessionButton = ({ durationSecsToExtend }: Props) => {
  const call = useCall();
      ...
      settings_override: {
        limits: {
          max_duration_seconds:
            settings.limits.max_duration_seconds + durationSecsToExtend,
        },
      },
    });
  }
...
<ExtendSessionButton durationSecsToExtend={1800} />;
```
