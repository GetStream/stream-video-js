...
import ParticipantLayoutGrid from '../assets/05-ui-cookbook/11-runtime-layout-switching/grid.png';
import ParticipantLayoutSpotlight from '../assets/05-ui-cookbook/11-runtime-layout-switching/spotlight.png';
...
![Preview of the Layout Switch Modal and Button](../assets/05-ui-cookbook/11-runtime-layout-switching/runtime-layout-switching-modal.png)
