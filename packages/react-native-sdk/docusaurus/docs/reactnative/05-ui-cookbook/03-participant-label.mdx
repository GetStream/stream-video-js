...
![Preview of the Default LocalParticipantView component](../assets/05-ui-cookbook/participant-label-default.png)
...
![Preview of the Custom LocalParticipantView component](../assets/05-ui-cookbook/participant-label-custom.png)
