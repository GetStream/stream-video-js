...
Preview of the Default Participant Label Component:

![Preview of the Default LocalParticipant component](../assets/05-ui-cookbook/participant-label-default.png)
...
![Preview of the Custom LocalParticipant component](../assets/05-ui-cookbook/participant-label-custom.png)
  ...
  return (
    <View>
      {participants.map((participant) => {
        // Code for your custom participant
        return (
          <View>
...
An example using the `useConnectedUser` hook is shown below. This can be useful while designing the Participant label component for the Lobby component:
