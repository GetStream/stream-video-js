...
:::note
The React Native SDK exports a pre-built component [CallControls](../../ui-components/call/call-controls) that we encourage to use if at all there is no customization needs.
:::
