...
<ImageShowcase
  items={[
    {
      image: LobbyViewCompletedOff,
      caption: 'Lobby View Completed Camera and Mic off',
      alt: 'Lobby View Completed Camera and Mic off',
    },
    {
      image: LobbyViewCompletedOn,
      caption: 'Lobby View Completed Camera and Mic on',
      alt: 'Lobby View Completed Camera and Mic on',
    },
  ]}
/>
