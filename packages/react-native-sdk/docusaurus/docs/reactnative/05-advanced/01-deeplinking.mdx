...
import XCodeInfoUrlTypesImage from '../assets/04-advanced/01-deeplinking/xcode-info-url-types.png';
import XCodeSigningCapabilities from '../assets/04-advanced/01-deeplinking/xcode-signing-capabilitites.png';

## Implementing Call Deep Linking

With this guide we provide the ability to deep link into an meeting/call application directly, using only the call ID. This capability is supported in React Native.

Our API makes it very easy to integrate and start your custom UI, or our existing screens powered by our UI components.

### Native Setup

> **Note**: Prerequisites before following this guide is having an application with an initialized StreamVideoSDK with an authenticated user.

If you're missing this step or simply want to refresh your memory, follow our [Tutorial](../01-basics/01-tutorial.mdx) to create a meeting-syle application. That application will serve as the foundation for this deep link guide.
...
<img src={XCodeInfoUrlTypesImage} />
...
<img src={XCodeSigningCapabilities} />
