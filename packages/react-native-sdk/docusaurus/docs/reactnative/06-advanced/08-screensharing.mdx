...
:::note
Expo is not supported yet. We are actively working on screen sharing support for Managed Expo apps and will be supported soon. 
:::
...
## Use the screen sharing button component of the SDK
