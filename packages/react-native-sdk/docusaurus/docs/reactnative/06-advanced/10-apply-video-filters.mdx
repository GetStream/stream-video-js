...
:::note
For Expo, make sure to create a new [Expo local module](https://docs.expo.dev/modules/get-started/#adding-a-new-module-to-an-existing-application) first if you dont have any existing module set up already.
:::
