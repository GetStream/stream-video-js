...
The only setup required for Android is to configure the Firebase library. Follow [this guide at react-native-firebase documentation](https://rnfirebase.io/#2-react-native-cli---android-setup) to generate credentials for your Android app and configure Firebase.
