...
This guide discusses how to add push notifications for calls that are not ringing to your project. We will discuss how to set up your Expo app to get push notifications from Stream for the non-ringing calls that your user will receive. 
