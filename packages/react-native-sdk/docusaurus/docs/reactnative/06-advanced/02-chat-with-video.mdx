...
To do this, we will take use of the [`chatButton`](../../ui-components/call/call-controls/#chatbutton) prop of the [`CallControls`](../../ui-components/call/call-controls) component.
...
Here, we use the [`IncomingCall`](../../ui-components/call/incoming-call/), [`OutgoingCall`](../../ui-components/call/outgoing-call/) to show the incoming and outgoing call component when the call is in ringing mode. We show the [`OutgoingCall`](../../ui-components/call/outgoing-call/) when the call is created by me, and the [`IncomingCall`](../../ui-components/call/incoming-call/) when the call is not created by me and is received from someone else. To do that we use the following snippet above using the `useCall` hook:
...
To show the joined call UI, we use the [`CallContent`](../../ui-components/call/call-content/) and the [`CallControls`](../../ui-components/call/call-controls/) component from the SDK.

![Preview of the Active call screen](../assets/06-advanced/02-chat-integration/active-call.png)
