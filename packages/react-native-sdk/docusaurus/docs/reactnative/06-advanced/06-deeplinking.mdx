...
If you have a React project, the `.well-known/apple-app-site-association` should go inside your `public` directory of the project.
...
- We handle the links using the built-in [Linking](https://reactnative.dev/docs/linking) API.
