...
This guide talks about deep linking into a [video call](../02-tutorials/01-video-calling.mdx) or a generic application directly. It also focuses on getting the call id or similar entity through a Deep link URL and thereby use it to start a call.

Our API makes it very easy to integrate and start with your custom UI, or our existing screens powered by our UI components.
...
![XCode Info URL Types](../assets/06-advanced/06-deeplinking/xcode-info-url-types.png)
...
![XCode Signing Capabilities](../assets/06-advanced/06-deeplinking/xcode-signing-capabilitites.png)
...
- The Native Setup is an important step to achieve deep linking in both Android and iOS.
- The Native steps should be followed one after the other, sequentially.
- To handle the Links in a React Native app the [Linking](https://reactnative.dev/docs/linking) API must be used.
