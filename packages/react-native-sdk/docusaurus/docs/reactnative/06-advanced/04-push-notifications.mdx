...
import iosCallkitLibrariesLinkImage from '../assets/06-advanced/04-push-notifications/ios-callkit-libraries-link.png';
import iosSearchPaths from '../assets/06-advanced/04-push-notifications/ios-search-paths.png';
import iosInfoPlist from '../assets/06-advanced/04-push-notifications/ios-info-plist.png';
  ...
  items={[
    {
      ...
      caption: (
        <span>
          Add <code>CallKit.framework</code> and <code>Intents.framework</code>{' '}
