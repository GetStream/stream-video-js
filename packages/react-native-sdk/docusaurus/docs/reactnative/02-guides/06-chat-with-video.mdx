...
follow [React Native Chat Tutorial](https://getstream.io/chat/react-native-chat/tutorial/) first and get a basic chat application ready in your app.

[//]: # ()
I stopped here!!!

[//]: # ()
You can customise your application according to your needs and business ideas. Follow our [React Native Chat Official Documentation](https://getstream.io/chat/docs/sdk/reactnative/) for this.
