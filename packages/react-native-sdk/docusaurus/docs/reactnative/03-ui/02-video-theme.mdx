...
The `VideoTheme` component is a wrapper that **you should use as the root** of all UI Components. It's used to provide the default properties that help us style the application, such as:
...
* **Shapes**: Defines several shapes we use across our UI components. Can be used to change the shape of avatars, dialogs, call controls, etc.
