...
Filter expressions support multiple match criteria and it's also possible to combine filters. For more information visit the [filter operators guide](https://getstream.io/chat/docs/react-native/query_syntax_operators/?language=javascript).
