...
:::tip
[`CallControlsView `](../../ui-components/call/call-controls-view/) utilizes [`ReactionsModal`](../../ui-components/utility/reactions-modal/) and components support reactions out-of-the-box, but for advanced use-cases you can also build your own reaction system.
