...
export const foundations: IStreamTokens['foundations'] = {
  ...
  colors: {
    ...
    baseTransparentBlack0: 'rgba(0, 0, 0, 0)',
    baseTransparentBlack15: 'rgba(0, 0, 0, 0.15)',
    baseTransparentBlack20: 'rgba(0, 0, 0, 0.2)',
    baseTransparentBlack25: 'rgba(0, 0, 0, 0.25)',
    baseTransparentBlack50: 'rgba(0, 0, 0, 0.5)',
    baseTransparentBlack75: 'rgba(0, 0, 0, 0.75)',
    baseTransparentWhite0: 'rgba(255, 255, 255, 0)',
    baseTransparentWhite15: 'rgba(255, 255, 255, 0.15)',
    baseTransparentWhite25: 'rgba(255, 255, 255, 0.25)',
    baseTransparentWhite50: 'rgba(255, 255, 255, 0.5)',
    baseTransparentWhite75: 'rgba(255, 255, 255, 0.75)',
    baseBlack: '#000000',
    baseWhite: '#ffffff',
    slate50: '#f6f8fa',
    slate100: '#ebeef1',
...
export const components: IStreamTokens['components'] = {
  ...
  buttonPaddingXIconOnlyLg: 16,
  buttonPaddingXIconOnlyMd: 12,
  buttonPaddingXIconOnlySm: 8,
  ...
  inputRadiusTextInput: primitives.radiusLg,
...
export const semantics: IStreamTokens['semantics'] = {
  ...
  accentWarning: foundations.colors.yellow200,
  avatarBgDefault: '$brand150',
  ...
  backgroundCoreOnElevation: '$chrome100',
  backgroundCoreOverlayDark: 'rgba(26, 27, 37, 0.25)',
  backgroundCoreOverlayDarkStrong: 'rgba(26, 27, 37, 0.75)',
  ...
  backgroundUtilitySkeletonLoadingBase: foundations.colors.baseTransparent0,
  backgroundUtilitySkeletonLoadingHighlight: '$backgroundCoreOverlayLight',
  ...
  borderCoreOnElevation: '$chrome150',
  ...
  controlAcceptCallButtonBg: '$accentSuccess',
  controlAcceptCallButtonText: '$textOnAccent',
  controlCallControlErrorBadgeBg: '$accentWarning',
  controlCallControlErrorBadgeText: foundations.colors.baseBlack,
  ...
  controlDeclineCallButtonBg: '$accentError',
  controlDeclineCallButtonText: '$textOnAccent',
  ...
  controlProgressBarFillAudio: '$accentPrimary',
  ...
  indicatorConnectionQualityFair: '$accentWarning',
  indicatorConnectionQualityGreat: '$accentSuccess',
  indicatorConnectionQualityPoor: '$accentError',
  indicatorMicrophoneLevelBarActive: '$brand400',
  indicatorMicrophoneLevelBarInactive: '$chrome200',
  indicatorSoundIndicatorSpeaking: '$brand400',
  inputTextDefault: '$textPrimary',
  inputTextDisabled: '$textDisabled',
  inputTextIcon: '$textTertiary',
  inputTextIconActive: '$textPrimary',
  inputTextPlaceholder: '$textTertiary',
  labelBgNeutral: '$chrome150',
  labelBgPrimary: '$brand150',
  labelTextNeutral: '$textPrimary',
  labelTextPrimary: '$brand900',
  messageBubbleBgAttachmentIncoming: '$backgroundCoreSurfaceStrong',
  messageBubbleBgAttachmentOutgoing: '$brand150',
  messageBubbleBgIncoming: '$backgroundCoreSurfaceDefault',
  messageBubbleBgMention: foundations.colors.baseTransparent0,
  messageBubbleBgMentionBroadcast: '$messageBubbleBgMention',
  messageBubbleBgMentionGroup: '$messageBubbleBgMention',
  messageBubbleBgMentionRole: '$messageBubbleBgMention',
  messageBubbleBgMentionUser: '$messageBubbleBgMention',
  messageBubbleBgOutgoing: '$brand100',
  messageBubbleBorderIncoming: '$borderCoreSubtle',
  messageBubbleBorderOnChatIncoming: '$borderCoreStrong',
  messageBubbleBorderOnChatOutgoing: '$brand300',
  messageBubbleBorderOutgoing: '$brand100',
  messageBubbleTextIncoming: '$textPrimary',
  messageBubbleTextLink: '$textLink',
  messageBubbleTextMention: '$textLink',
  messageBubbleTextMentionBroadcast: '$messageBubbleTextMention',
  messageBubbleTextMentionGroup: '$messageBubbleTextMention',
  messageBubbleTextMentionRole: '$messageBubbleTextMention',
  messageBubbleTextMentionUser: '$messageBubbleTextMention',
  messageBubbleTextOutgoing: '$brand900',
  messageBubbleTextReaction: '$textSecondary',
  messageBubbleTextRead: '$accentPrimary',
  messageBubbleTextSystem: '$textSecondary',
  messageBubbleTextTimestamp: '$textTertiary',
  messageBubbleTextTypingIndicator: '$messageBubbleTextIncoming',
  messageBubbleTextUsername: '$textSecondary',
  pollProgressFillIncoming: '$controlProgressBarFill',
  pollProgressFillOutgoing: '$accentPrimary',
  pollProgressTrackIncoming: '$controlProgressBarTrack',
  pollProgressTrackOutgoing: '$brand200',
  reactionBg: '$backgroundCoreElevation3',
  reactionBorder: '$borderCoreDefault',
  reactionEmoji: '$textPrimary',
  reactionText: '$textPrimary',
  replyIndicatorIncoming: '$chrome400',
  replyIndicatorOutgoing: '$brand400',
  systemBgBlur: 'rgba(255, 255, 255, 0.01)',
  systemCaret: '$accentPrimary',
  systemScrollbar: 'rgba(0, 0, 0, 0.5)',
  systemText: '$chrome1000',
  tabIndicator: '$accentPrimary',
  tabText: '$textSecondary',
  tabTextSelected: '$accentPrimary',
  tabTrack: '$borderCoreDefault',
  ...
  threadConnectorIncoming: '$borderCoreDefault',
  threadConnectorOutgoing: '$brand150',
  waveformBar: '$borderCoreOpacityStrong',
  waveformBarPlaying: '$accentPrimary',
} as const;
