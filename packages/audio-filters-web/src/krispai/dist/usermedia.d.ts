...
declare class UserMedia extends EventTarget {
  private options;
  stream: MediaStream;
  audioContext: AudioContext | undefined;
  filterNode: TAudioFilterNode | undefined;
  sampleRate: number | undefined;
  private sdk;
  private isLoading;
  private devices;
  private activeAudioDeviceGroupId;
  constructor(options?: IUserMediaOptions);
  private _onDeviceListChange;
  initSDK(
    options: ConstructorParameters<typeof KrispSDK>[0],
  ): Promise<KrispSDK>;
  loadUserMedia(
    constrains: MediaStreamConstraints,
    options?: ILoadUserMediaOptions,
  ): Promise<MediaStream>;
  private onUserMediaReady;
  private onUserMediaDisposed;
  isBVCEnabled(): boolean | undefined;
...
export declare type TAudioFilterNode = Awaited<
  ReturnType<KrispSDK['createNoiseFilter']>
>;
...
export interface ILoadUserMediaOptions {
  isInbound: boolean;
  forceAllowBVC: boolean;
  enableOnceReady: boolean;
}
...
export interface IUserMediaOptions {
