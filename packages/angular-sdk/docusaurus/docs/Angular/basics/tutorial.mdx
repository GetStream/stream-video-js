...
To join a call, pass the call ID to the [`joinCall`](../../core/StreamVideoClient/#joincall) method of the `StreamVideoClient` instance. This method will return a [`Call`](../../core/Call) instance that represents the active call the user is part of.
