...
:::important
When implementing a ring call scenario as we do in this demo, it is important to have a good understanding of our **ring call lifecycle**. You can learn more about the topic on the [doc page dedicated to call lifecycles](../call-lifecycle#ring-call).
:::
