...
This library is available as a npm package and works as a plugin for the [Stream React Video SDK](https://getstream.io/video/sdk/react/).
It isn't built-in within the SDK as we want to keep the core library as lightweight as possible.
We've made the SDK extensible so you can add any custom filters you want.
...
:::note
This library supports only modern desktop browsers.
