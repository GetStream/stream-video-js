...
Our SDK will log errors or warnings in browser's console unless disabled. We try to have a descriptive error messages
that should guide you to faster problem resolution. Also, using browser's Network tab can help you spot failing network requests and the reasons for it.
