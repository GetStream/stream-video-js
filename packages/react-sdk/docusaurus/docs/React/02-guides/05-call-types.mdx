...
The Video SDK uses a set of pre-defined call types that come with different default permissions.
...
:::note
If you want to learn more about the lifecycle of a call head over to the [Call Lifecycle](../02-call-lifecycle) page.
:::
...
A capability defines the actions that a certain is allowed to perform on a call. There are many different
...
:::tip
If you want to learn more about doing this, head over to the [Permissions and Capabilities](../../advanced/03-permissions-and-capabilities) chapter.
:::
