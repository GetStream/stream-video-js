...
- Give a conceptual overview of our permission system (roles, app vs call level roles, how own_capabilities is computed)
...
In our React Video SDK, you can use the [`useHasPermissions`](../04-call-engine/hooks-and-contexts.md#useHasPermissions) hook to check for permissions.
...
In our React Video SDK, you can use the [`useOwnCapabilities`](../04-call-engine/hooks-and-contexts.md#useOwnCapabilities) hook.
