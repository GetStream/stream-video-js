...
In case you need to use a stateful comparator, please make sure to memoize it using [`React.useMemo`](https://reactjs.org/docs/hooks-reference.html#usememo) or [`React.useCallback`](https://reactjs.org/docs/hooks-reference.html#usecallback) hooks.
