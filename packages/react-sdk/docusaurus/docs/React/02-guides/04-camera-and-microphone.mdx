...
:::info
We use these hooks in pre-built components like [`VideoPreview`](todo docs link) and [`DeviceSelector` components](todo docs link).
:::
...
:::info
The `useOnUnavailableVideoDevices` hook is used in a pre-build component [`VideoPreview`](todo docs link). Even after video device reconnection, the video preview is not restarted automatically and has to be enabled back manually by a user.
:::
...
|----------|-----------------------------|
| `setInitialAudioEnabled` | [`ToggleAudioPublishingButton`](todo docs link) |
| `setInitialVideoState` | [`VideoPreview`](todo docs link), [`ToggleVideoPublishingButton`](todo docs link) |
| `toggleInitialAudioMuteState` | [`ToggleAudioPreviewButton`](todo docs link) |
| `toggleInitialVideoMuteState` | [`ToggleVideoPreviewButton`](todo docs link) |
...
- [`DeviceSelectorAudioInput`](todo docs link)
- [`DeviceSelectorAudioOutput`](todo docs link)
- [`DeviceSelectorVideo`](todo docs link)
...
| Function | Used in pre-built component |
|----------|-----------------------------|
| `publishAudioStream`, `stopPublishingAudio` | [`ToggleAudioPublishingButton`](todo docs link) |
| `publishVideoStream`, `stopPublishingVideo` | [`ToggleVideoPublishingButton`](todo docs link) |
