...
2. Initiate the project (you can follow our [introductory tutorial setup guide](../../basics/01-tutorial#set-up-for-success))
3. Have installed the Stream video and chat SDKs:
```shell
