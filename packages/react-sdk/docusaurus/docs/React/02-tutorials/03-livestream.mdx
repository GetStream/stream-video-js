...
For that purpose, we will use the SDK-provided `<StreamMeeting /`> component to establish a WebRTC-based call for the hosts.
...
In this example, we use the predefined [`<PaginatedGridLayout>`](TODO) for the live stream.
