...
The app boilerplate can be found [here](https://github.com/GetStream/stream-video-js/tree/main/sample-apps/react/cookbook-participant-list).
...
You can read more about this in the [Sorting API](http://link.here).

The Participant Sorting API is customizable and allows you to define your own custom sorting logic in case our
default one doesn't fit your use-case.
...
2. In group calls, we would like to have this custom participant sorting:
...
Now as we have the sorting function, let's go ahead and apply it to the call.
