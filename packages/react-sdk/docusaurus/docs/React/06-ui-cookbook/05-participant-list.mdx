...
We won't be covering the styling in this tutorial, but you can find the full code in the [SpeakerView.scss](https://github.com/GetStream/stream-video-js/sample-apps/react/cookbook-participant-list/src/SpeakerView.scss) file.
