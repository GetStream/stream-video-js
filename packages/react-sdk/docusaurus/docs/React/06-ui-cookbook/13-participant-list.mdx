...
1. Declarative, using the [`<StreamMeeting />`](TODO#streammeeting) component.
...
You can read more about this mechanism as part of our [React Bindings and Hooks documentation](../../call-engine/overview).
...
The React Video SDK is built on top of the data model that our [call engine](../../call-engine/overview) exposes.
