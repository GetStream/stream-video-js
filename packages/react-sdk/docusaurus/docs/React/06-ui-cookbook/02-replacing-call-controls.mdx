...
:::note
The React SDK exports a pre-built component [`CallControls`](todo docs link). If it does not meet all the requirements, we encourage everybody to assemble their own `CallControls` component.
:::
