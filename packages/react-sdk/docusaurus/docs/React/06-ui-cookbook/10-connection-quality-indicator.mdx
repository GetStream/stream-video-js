...
You'll most likely be displaying this indicator component inside each participant box ((ParticipantView)[../../ui-components/core/participant-view]) within a call layout, you can learn more about `ParticipantViewUI` customizations in [the participant view customizations guide](./14-participant-view-customizations.mdx).
