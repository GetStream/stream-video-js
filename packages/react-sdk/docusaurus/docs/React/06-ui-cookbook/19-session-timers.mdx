...
![SessionTimer component in use](../assets/19-session-timers/session-timer.png)
...
![Alert indicating that session is about to end](../assets/19-session-timers/session-timer-alert.png)
...
![Alert with an option to extend the sesion by 30 minutes](../assets/19-session-timers/session-timer-extend.png)
