...
Or, if instead of using [`StreamCall`](../../ui-components/core/stream-call), we want to use the [`MediaDevicesProvider`](../../call-engine/hooks-and-contexts#mediadevicesprovider) component directly, we pass `initialVideoEnabled` value to it as follows:
