...
export const App = () => {
  ...
  return (
    <StreamVideo client={client}>
      {/* highlight-next-line */}
      <StreamCall callId={callId} callType="default" input={{ create: true }}>
        <SpeakerView />
        {/* highlight-next-line */}
      </StreamCall>
    </StreamVideo>
