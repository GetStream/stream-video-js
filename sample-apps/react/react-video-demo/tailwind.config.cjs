...
module.exports = {
  content: ['./src/components/**/*.{html, js, ts, tsx}', './src/**/*'],
  theme: {
    borderWidth: {
      default: '1px',
      DEFAULT: '1px',
    ...
    boxShadow: {
      ...
      button:
        '0 1px 1px 0 rgba(0, 94, 173, 1), 0 3px 13px 0 rgba(0, 125, 238, 0.32)',
      ...
      footer:
        'inset 0 1px 0 0 rgba(0,0,0,0.07), inset 0 8px 7px 0 rgba(0,0,0,0.01)',
